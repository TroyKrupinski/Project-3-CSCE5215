...
class CarBayesianNetwork:
    ...
    def calculate_p_car_wont_start_given_fanbelt(self, fanbelt_state='y'):
        total_prob = 0
    ...
    def print_detailed_calculation(self, fanbelt_state='y'):
        # Print intermediate probabilities for key paths
        ...
        final_prob = self.calculate_p_car_wont_start_given_fanbelt(fanbelt_state)
        print(f"\nFinal P(car_won't_start|fanbelt={fanbelt_state}) = {final_prob:.4f}")
        return final_prob
